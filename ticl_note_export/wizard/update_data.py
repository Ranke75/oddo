...
class ticl_note_data(models.TransientModel):
    _name = "ticl.note.data"
...
#        worksheet.write(1, 5, new_from_date, easyxf('font:height 200;font:bold True;align: horiz center;'))
        ...
        worksheet.write(3, 0, _('Name'), column_heading_style) 
        worksheet.write(3, 1, _('Comments'), column_heading_style)
        ...
        for wizard in self:
            ...
            for inventory in inventory_objs:
                ...
                worksheet.write(row, 0, inventory.reference or '')
            ...
            wizard.file_name = str(wizard.from_date)+'_'+'customer_note.xls'
            wizard.inventory_report_printed = True
            fp.close()
            return {
                    'view_mode': 'form',
                    'res_id': wizard.id,
                    'res_model': 'ticl.note.data',
                    'view_type': 'form',
